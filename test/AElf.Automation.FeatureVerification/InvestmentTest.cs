        ...
        */
        ...
        public void InitializeTest()
        {
           ...
           */
            ...
            var providerInitialize= _awakenProviderContract.ExecuteMethodWithResult(AwakenProviderContractMethod.Initialize,
            ...
            var providerInitialize1 =_awakenProviderContract1.ExecuteMethodWithResult(AwakenProviderContractMethod.Initialize,
                new Awaken.Contracts.Provider.InitializeInput
                {
                    Controller=InvestmentAddress.ConvertAddress(),
                    PlatformTokenSymbol = "AWAKEN",
            ...
            var investmentInitialize =  _awakenInvestmentContract.ExecuteMethodWithResult(AwakenInvestmentContractMethod.Initialize,
               new Empty());
        ...
        public void AddProvider()
        {
            ...
            resultAdminAddress.Status.ConvertTransactionResultStatus().ShouldBe(TransactionResultStatus.NodeValidationFailed);
        ...
        public void ChooseProvider()
        {
            ...
            resultChooseProvider1.Status.ConvertTransactionResultStatus().ShouldBe(TransactionResultStatus.NodeValidationFailed);
        ...
        public void ChangeBeneficiary()
        {
            ...
            changeBeneficiary.Status.ConvertTransactionResultStatus().ShouldBe(TransactionResultStatus.NodeValidationFailed);
        ...
        public void EmergencePause()
        {
            ...
            emergencePause.Status.ConvertTransactionResultStatus().ShouldBe(TransactionResultStatus.NodeValidationFailed);
        ...
        public void ChangeReservesRatio()
        {
           ...
           changeReservesRatio.Status.ConvertTransactionResultStatus().ShouldBe(TransactionResultStatus.NodeValidationFailed);
        ...
        public void EmergenceWithdraw()
        {
            ...
            emergenceWithdraw.Status.ConvertTransactionResultStatus().ShouldBe(TransactionResultStatus.NodeValidationFailed);
            ...
            emergenceWithdrawFaile.Status.ConvertTransactionResultStatus().ShouldBe(TransactionResultStatus.NodeValidationFailed);
        ...
        public void Withdraw()
        {
            ...
            withdrawFaile.Status.ConvertTransactionResultStatus().ShouldBe(TransactionResultStatus.NodeValidationFailed);
        ...
        public void WithdrawWithReBalance()
        {
            ...
            withdrawWithReBalance.Status.ConvertTransactionResultStatus().ShouldBe(TransactionResultStatus.NodeValidationFailed);
            ...
            withdrawWithReBalanceFaile.Status.ConvertTransactionResultStatus().ShouldBe(TransactionResultStatus.NodeValidationFailed);
