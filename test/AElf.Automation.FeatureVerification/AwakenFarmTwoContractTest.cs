...
namespace AElf.Automation.Contracts.ScenarioTest
{
    ...
    public class GandalfFarmContractTest
    {
        ...
        public void Initialize()
        {
            ...
            _awakenFarmTwoContract = farmPoolTwoAddress == ""
                ? new AwakenFarmTwoContract(NodeManager, InitAccount)
                : new AwakenFarmTwoContract(NodeManager, InitAccount, farmPoolTwoAddress);
        }
        ...
        public void InitializeTest()
        {
            ...
            if (!IsTokenExist(DISTRIBUTETOKEN))
            {
                ...
                IssueBalance(DISTRIBUTETOKEN, 100000000000, _awakenFarmTwoContract.ContractAddress.ConvertAddress(),
                    $"issue balance{DISTRIBUTETOKEN}");
            }

            if (_tokenContract.GetUserBalance(_awakenFarmTwoContract.ContractAddress, DISTRIBUTETOKEN) == 0)
                IssueBalance(DISTRIBUTETOKEN, 100000000000, _awakenFarmTwoContract.ContractAddress.ConvertAddress(),
                    $"issue balance{DISTRIBUTETOKEN}");

            Logger.Info(
                $"start/end block {_awakenFarmTwoContract.GetStartBlock().Value}/{_awakenFarmTwoContract.EndBlock().Value}");
            Logger.Info($"total reward {_awakenFarmTwoContract.TotalReward().Value}");
            Logger.Info($"halving period {_awakenFarmTwoContract.GetHalvingPeriod().Value}");
            Logger.Info($"reward per block {_awakenFarmTwoContract.GetDistributeTokenBlockReward().Value}");
        }
        ...
        public void AddTest()
        {
            ...
            var lastRewardBlock = addPoolTwoResult.BlockNumber > _awakenFarmTwoContract.GetStartBlock().Value
            ...
            var poolOne = _awakenFarmTwoContract.GetPoolInfo(0);
            poolOne.AllocPoint.ShouldBe(0);
            poolOne.LpToken.ShouldBe(LPTOKEN);

            //validate pool 1 info
            var poolTwo = _awakenFarmTwoContract.GetPoolInfo(1);
        ...
        public void DepositWithNoApprovementTest()
        {
            ...
            var depositResultA = _awakenFarmTwoContract.Deposit(1, 10000000000);
            depositResultA.Status.ConvertTransactionResultStatus()
        ...
        {
            var depositResult = _awakenFarmTwoContract.Deposit(0, 10000000000000);
            depositResult.Status.ConvertTransactionResultStatus()
                .ShouldBe(TransactionResultStatus.NodeValidationFailed);
            depositResult.Error.ShouldContain("Invalid pid");

            var result = _awakenFarmTwoContract.Deposit(10, 10000000000000);
            result.Status.ConvertTransactionResultStatus().ShouldBe(TransactionResultStatus.NodeValidationFailed);
        ...
        {
            _awakenFarmTwoContract.SetAccount(UserB);

            //Add
            var poolLength = GetPoolLength();
            var addResult = _awakenFarmTwoContract.Add(10, LPTOKEN, false);
            ...
            //Set
            var poolInfo = _awakenFarmTwoContract.GetPoolInfo(1);
            var rewardperblock = _awakenFarmTwoContract.GetDistributeTokenBlockReward();
            var setResult = _awakenFarmTwoContract.Set(1, 10, 16, true);
            ...
            _awakenFarmTwoContract.GetPoolInfo(1).AllocPoint.ShouldBe(poolInfo.AllocPoint);
            _awakenFarmTwoContract.GetDistributeTokenBlockReward().ShouldBe(rewardperblock);

            //SetDistributeTokenPerBlock
            var setDistributeTokenPerBlockResult = _awakenFarmTwoContract.SetDistributeTokenPerBlock(16);
            ...
            //SetHalvingPeriod
            var halvingperiod = _awakenFarmTwoContract.GetHalvingPeriod();
            var setHalvingPeriodResult = _awakenFarmTwoContract.SetHalvingPeriod(1000);
            setHalvingPeriodResult.Status.ConvertTransactionResultStatus()
                .ShouldBe(TransactionResultStatus.NodeValidationFailed);
            _awakenFarmTwoContract.GetHalvingPeriod().ShouldBe(halvingperiod);

            //SetFarmPoolOne
            var farmpoolone = _awakenFarmTwoContract.FarmPoolOne();
            var setFarmPoolOneResult =
                _awakenFarmTwoContract.SetFarmPoolOne(
            ...
            _awakenFarmTwoContract.FarmPoolOne().ShouldBe(farmpoolone);

            //FixEndBlock
            var endblock = _awakenFarmTwoContract.EndBlock();
            ...
            _awakenFarmTwoContract.EndBlock().ShouldBe(endblock);
        ...
        public void DepositBeforeStartBlock()
        {
            ...
            //do deposit
            var result = _awakenFarmTwoContract.Deposit(1, 10000000000);
            result.Status.ConvertTransactionResultStatus().ShouldBe(TransactionResultStatus.Mined);
            ...
            var issuedReward = _awakenFarmTwoContract.IssuedReward();
        ...
        public void DepositAfterStartBlock()
        {
            ...
            //Do deposit
            var depositResult = _awakenFarmTwoContract.Deposit(1, 10000000000);
            ...
            balanceAfterDeposit.ShouldBe(balanceBeforeDeposit - 10000000000);
            userAmountAfterDeposit.ShouldBe(userAmountBeforeDeposit.Add(10000000000));
            new BigIntValue(distributeTokenAfter).ShouldBe(
                transferDistritubeToken.Add(new BigIntValue(distributeTokenBefore)));
        }
        ...
        public void WithdrawTest()
        {
            ...
            //Do withdraw
            var withdrawResult = _awakenFarmTwoContract.Withdraw(1, userAmountBeforeWithdraw);
        ...
        public void WithdrawWithInsufficientAmount()
        {
            ...
            //do withdraw
            var result = _awakenFarmTwoContract.Withdraw(1, userAmount.Add(100));
        ...
        public void WithdrawAmountZeroTest()
        {
            ...
            var totoalamount = _awakenFarmTwoContract.GetPoolInfo(1).TotalAmount;

            //do withdraw
            var withdrawResult =
                _awakenFarmTwoContract.Withdraw(1, 0);
            withdrawResult.Status.ConvertTransactionResultStatus().ShouldBe(TransactionResultStatus.Mined);
            var distributetokenafter = _tokenContract.GetUserBalance(InitAccount, DISTRIBUTETOKEN);
        ...
        public void DepositWithdrawTest()
        {
            ...
            Logger.Info(_tokenContract.GetUserBalance(_awakenFarmTwoContract.ContractAddress, DISTRIBUTETOKEN));
            ...
            var lastRewardBlock = GetLastRewardBlock(1);
            //do withdraw
            var result = _awakenFarmTwoContract.Withdraw(1, userAmountBeforeWithdraw);
        ...
        public void NoRewardAfterWithdrawAllTest()
        {
            ...
            //do withdraw
            var result = _awakenFarmTwoContract.Withdraw(1, _awakenFarmTwoContract.GetUserInfo(1, InitAccount).Amount);
            var withdrawBlock = result.BlockNumber;
            var distributetokenafter = _tokenContract.GetUserBalance(InitAccount, DISTRIBUTETOKEN);

            //Do deposit
            var deposit = _awakenFarmTwoContract.Deposit(1, 10000000000);
        ...
        public void PendingTest()
        {
            ...
            var depositResult = _awakenFarmTwoContract.Deposit(1, 10000000000);
            depositResult.Status.ConvertTransactionResultStatus().ShouldBe(TransactionResultStatus.Mined);
            var amount = _awakenFarmTwoContract.GetUserInfo(1, InitAccount).Amount;
            var totalamout = _awakenFarmTwoContract.GetPoolInfo(1).TotalAmount;
        ...
        public void TwoUsersDepositBeforePhase0WithdrawAfterPhase3()
        {
            ...
            //usera deposit
            var depositUserA = _awakenFarmTwoContract.Deposit(1, 10000000000);
            ...
            var totalAmountAfterDepositUserA = _awakenFarmTwoContract.GetPoolInfo(1).TotalAmount;
            var userAmountAfterDepositUserA = _awakenFarmTwoContract.GetUserInfo(1, InitAccount).Amount;
            var rewardDebtAfterDepositUserA = _awakenFarmTwoContract.GetUserInfo(1, InitAccount).RewardDebt;
            ...
            Logger.Info(
                $"total/user/block/debt:{totalAmountAfterDepositUserA},{userAmountAfterDepositUserA},{depositBlockUserA}{rewardDebtAfterDepositUserA}");

            //userb deposit
            _awakenFarmTwoContract.SetAccount(UserB);
            var depositUserB = _awakenFarmTwoContract.Deposit(1, 5000000000);
            ...
            var totalAmountAfterDepositUserB = _awakenFarmTwoContract.GetPoolInfo(1).TotalAmount;
            var userAmountAfterDepositUserB = _awakenFarmTwoContract.GetUserInfo(1, UserB).Amount;
            var rewardDebtAfterDepositUserB = _awakenFarmTwoContract.GetUserInfo(1, UserB).RewardDebt;
            ...
            _awakenFarmTwoContract.SetAccount(InitAccount);
            var withdrawUserA =
                _awakenFarmTwoContract.Withdraw(1, _awakenFarmTwoContract.GetUserInfo(1, InitAccount).Amount);
            ...
            var totalAmountAfterWithdrawUserA = _awakenFarmTwoContract.GetPoolInfo(1).TotalAmount;
            var userAmountAfterWithdrawUserA = _awakenFarmTwoContract.GetUserInfo(1, InitAccount).Amount;
            var rewardDebtAfterWithdrawUserA = _awakenFarmTwoContract.GetUserInfo(1, InitAccount).RewardDebt;
            ...
            Logger.Info(
                $"total/user/block/debt:{totalAmountAfterWithdrawUserA},{userAmountAfterWithdrawUserA},{withdrawUserABlock}{rewardDebtAfterWithdrawUserA}");

            var transferDistributeTokenUserA = GetTransferDistributeToken(depositUserB, 1, depositBlockUserA,
                depositBlockUserB,
                userAmountAfterDepositUserA, totalAmountAfterDepositUserA).Add(GetTransferDistributeToken(withdrawUserA,
                1,
                depositBlockUserB, withdrawUserABlock, userAmountAfterDepositUserA, totalAmountAfterDepositUserB));
            transferDistributeTokenUserA.ShouldBe(
                new BigIntValue(distributeTokenAfterWithdrawUserA - distributeTokenAfterDepositUserA));


            //userb withdraw
            _awakenFarmTwoContract.SetAccount(UserB);
            var withdrawUserB = _awakenFarmTwoContract.Withdraw(1, _awakenFarmTwoContract.GetUserInfo(1, UserB).Amount);
            ...
            var totalAmountAfterWithdrawUserB = _awakenFarmTwoContract.GetPoolInfo(1).TotalAmount;
            var userAmountAfterWithdrawUserB = _awakenFarmTwoContract.GetUserInfo(1, UserB).Amount;
            var rewardDebtAfterWithdrawUserB = _awakenFarmTwoContract.GetUserInfo(1, UserB).RewardDebt;
            //validate distribute token
            ...
            Logger.Info(
                $"total/user/block/debt:{totalAmountAfterWithdrawUserB},{userAmountAfterWithdrawUserB},{withdrawUserBBlock}{rewardDebtAfterWithdrawUserB}");
        ...
        {
            var allocpoint = 3;
            var perblock = _awakenFarmTwoContract.GetDistributeTokenBlockReward();
            var poolAllocPoint = _awakenFarmTwoContract.GetPoolInfo(1).AllocPoint;
            ...
            //do Set
            var setResult = _awakenFarmTwoContract.Set(1, allocpoint, perblock, true);
            ...
            transferdistributeToken.ShouldBe(
                new BigIntValue(distributeTokenAfter).Sub(new BigIntValue(distributeTokenBefore)));
        }
        ...
        public void SetPoolDistributeTokenPerBlockTest()
        {
            ...
            //do Withdraw
            var withdrawResult =
                _awakenFarmTwoContract.Withdraw(1,
                    _awakenFarmTwoContract.GetUserInfo(1, InitAccount).Amount.Div(new BigIntValue(2)));
            withdrawResult.Status.ConvertTransactionResultStatus().ShouldBe(TransactionResultStatus.Mined);
            ...
            transferDistributeToken.ShouldBe(
                new BigIntValue(transferDistributeTokenAfter).Sub(new BigIntValue(transferDistributeTokenBefore)));
        }
        ...
        public void FixEndBlockTest()
        {
            ...
            Logger.Info(
                $"total reward {_awakenFarmTwoContract.TotalReward().Sub(_awakenFarmTwoContract.IssuedReward())}");
            ...
            //do withdraw
            var withdrawResult = _awakenFarmTwoContract.Withdraw(1, amount);
            withdrawResult.Status.ConvertTransactionResultStatus().ShouldBe(TransactionResultStatus.Mined);
            var distributeTokenAfter = _tokenContract.GetUserBalance(InitAccount, DISTRIBUTETOKEN);
            Logger.Info(distributeTokenAfter);

            Logger.Info(distributeTokenAfter - distributeTokenBefore);
            Logger.Info(_awakenFarmTwoContract.TotalReward());
            Logger.Info(_awakenFarmTwoContract.TotalReward().Sub(issuedAfterFix));
            Logger.Info(GetTransferDistributeToken(1,
                fixEndBlockResult.BlockNumber, _awakenFarmTwoContract.EndBlock().Value, amount, totalamount));

            new BigIntValue(distributeTokenAfter - distributeTokenBefore).ShouldBe(_awakenFarmTwoContract
                .TotalReward());
            _awakenFarmTwoContract.TotalReward().Sub(issuedAfterFix).ShouldBe(GetTransferDistributeToken(1,
                fixEndBlockResult.BlockNumber, _awakenFarmTwoContract.EndBlock().Value, amount, totalamount));
        }
            ...
            long txblock, BigIntValue useramount, BigIntValue poolTotalAmount)
        {
            ...
            var n = _awakenFarmTwoContract.GetPhase(lastrewardblock).Value;
            var m = _awakenFarmTwoContract.GetPhase(rewardblock).Value;
            ...
            while (n < m)
            {
                ...
                var reward = _awakenFarmTwoContract.Reward(new Int64Value
                {
                    Value = r
                });
            ...
            blockreward = blockreward.Add(_awakenFarmTwoContract.Reward(new Int64Value
                {
                    Value = rewardblock
                })
                .Mul(rewardblock.Sub(lastrewardblock)));

            var poolAllocPoint = _awakenFarmTwoContract.GetPoolInfo(pid).AllocPoint;
            var totalAllocPoint = _awakenFarmTwoContract.TotalAllocPoint().Value;
            ...
            long txblock, BigIntValue useramount, BigIntValue poolTotalAmount, BigIntValue distributetokenperblock)
        {
            ...
            while (n < m)
            {
                ...
                var phase = _awakenFarmTwoContract.GetPhase(r);
        ...
        {
            var result = _awakenFarmTwoContract.GetUserInfo(pid, user);
